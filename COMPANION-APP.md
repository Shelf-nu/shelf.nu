...
The mobile app currently lives at `apps/mobile/` alongside `apps/webapp/` and `apps/docs/`.
...
Extract `apps/mobile/` into its own repo. The webapp API routes stay in the main repo.
