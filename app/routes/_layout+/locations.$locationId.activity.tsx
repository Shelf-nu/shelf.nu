...
type SerializedLocationNote = Omit<
  LocationNoteWithUser,
  "createdAt" | "updatedAt"
> & {
  createdAt: string;
  updatedAt: string;
...
export async function loader({ context, request, params }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const serializedNotes: SerializedLocationNote[] = notes.map((note) => ({
      ...note,
      createdAt: note.createdAt.toISOString(),
      updatedAt: note.updatedAt.toISOString(),
      dateDisplay: formatter.format(note.createdAt),
    }));
