-- DropIndex
DROP INDEX "Asset_categoryId_organizationId_idx";

-- DropIndex
DROP INDEX "Asset_createdAt_organizationId_idx";

-- DropIndex
DROP INDEX "Asset_kitId_organizationId_idx";

-- DropIndex
DROP INDEX "Asset_locationId_organizationId_idx";

-- DropIndex
DROP INDEX "Asset_organizationId_compound_idx";

-- DropIndex
DROP INDEX "Asset_status_organizationId_idx";

-- DropIndex
DROP INDEX "Asset_valuation_organizationId_idx";

-- DropIndex
DROP INDEX "AssetCustomFieldValue_lookup_idx";

-- DropIndex
DROP INDEX "Custody_assetId_teamMemberId_idx";

-- DropIndex
DROP INDEX "Qr_assetId_idx";
