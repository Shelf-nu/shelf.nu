...
export default function FormRow({
  ...
  return (
    <div className={tw(`flex gap-8 border-b  py-6`, className)}>
      <div className="hidden lg:block lg:min-w-[280px] lg:basis-[280px]">
        <div
          className={tw(
            "text-text-sm font-medium text-color-700",
            required && "required-input-label"
          )}
        >
          {rowLabel}
        </div>
        <SubHeading className="text-xs text-color-600">{subHeading}</SubHeading>
      </div>
