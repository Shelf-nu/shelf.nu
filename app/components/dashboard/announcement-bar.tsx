...
export default function AnnouncementBar() {
  ...
  return announcement ? (
    <div className="mb:gap-4 mb:p-4 mb-4 mt-3 flex items-center gap-2 rounded border border-color-200 px-2 py-3">
      <div className="bg-primary-100 inline-flex items-center justify-center rounded-full border-[6px] border-solid border-primary-50 p-1.5 text-primary">
        <StarsIcon />
      </div>
