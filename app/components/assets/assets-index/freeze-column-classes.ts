...
> = {
  ...
  name: tw(
    ...
    "after:absolute after:inset-y-0 after:right-[0.5px] after:border-r after:border-color-200 after:content-['']"
    // "before:absolute before:inset-x-0 before:bottom-0 before:border-b before:border-color-200 before:content-['']"
  ),
};
