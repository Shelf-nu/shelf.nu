...
export function useActionSwitcher() {
  const [open, setOpen] = useState(false);
  const [action, setAction] = useState<ActionType>("View asset");
  ...
  function changeAction(action: ActionType) {
    setAction(action);
    setSelectedIndex(ACTIONS.indexOf(action));
    setOpen(false);
  }
  ...
  return { action, Component: ActionSwitcher };
}
