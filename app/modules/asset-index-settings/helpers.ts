...
export const columnsLabelsMap: { [key in ColumnLabelKey]: string } = {
  ...
  tags: "Tags",
  location: "Location",
  firstScanLocation: "First scan location",
...
export const defaultFields: Column[] = [
  ...
  { name: "firstScanLocation", visible: false, position: 12 },
  { name: "lastScanLocation", visible: false, position: 13 },
  { name: "kit", visible: true, position: 14 },
  { name: "custody", visible: true, position: 15 },
  { name: "upcomingReminder", visible: true, position: 16 },
  { name: "actions", visible: true, position: 17 },
  { name: "upcomingBookings", visible: true, position: 18 },
];
