...
Edit `.env` with your Supabase credentials and other configuration. See the [Supabase setup guide](./docs/supabase-setup.md) for step-by-step instructions.
...
For detailed setup instructions including SSL certificates and troubleshooting, see the [local development guide](./docs/local-development.md).
...
Shelf deploys to [Fly.io](https://fly.io/) with GitHub Actions for CI/CD. Push to `main` triggers: lint, typecheck, test, Docker build, and deploy.

See the [deployment guide](./docs/deployment.md) for full setup instructions.
...
| Guide | Description |
|-------|-------------|
| [Local Development](./docs/local-development.md) | Full local setup with SSL, monorepo overview |
| [Supabase Setup](./docs/supabase-setup.md) | Database, auth, storage configuration |
| [Deployment](./docs/deployment.md) | Fly.io + GitHub Actions CI/CD |
| [Docker](./docs/docker.md) | Self-hosted Docker setup |
| [App Configuration](./docs/app-configuration.md) | `shelf.config.ts` options |
| [Error Handling](./docs/handling-errors.md) | Error patterns and conventions |
