                ...
                >
                  {assetCanBeReleased ? (
                    <Button
                      ...
                      role="link"
                      variant="link"
                      className="justify-start whitespace-nowrap px-4 py-3 text-color-700 hover:bg-slate-100 hover:text-color-700"
                      width="full"
                  ...
                  <DeleteAsset
                    ...
                    trigger={
                      <Button
                        ...
                        icon="trash"
                        className="justify-start rounded-sm px-4 py-3 text-sm font-semibold text-color-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-slate-100 hover:text-color-700"
                        width="full"
                        disabled={
                          assetIsCheckedOut || assetIsPartOfUnavailableKit
                        }
