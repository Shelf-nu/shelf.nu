            ...
            <div className="content-inner relative mb-[60px] max-h-[412px] overflow-y-scroll">
              <div className="py-[2px]">
                ...
                <ColumnRow className="flex items-center gap-1 pb-2">
                  <FakeCheckbox
                    checked={true}
                    className={tw("mr-1 text-color-600")}
                  />
                  Name
                </ColumnRow>
              </div>
                      ...
                      <ColumnRow key={column.name}>
                        <div className="flex items-center gap-1">
                          ...
                          <div
                            ...
                            className="flex flex-1 items-center text-[14px] font-medium text-color-700 hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary"
                            title="Custom field"
                          >
                            {" "}
                            <FakeCheckbox
                          ...
                          <button
                            ...
                            className="flex h-auto cursor-move items-center p-1 text-color-500 focus:outline-none focus:ring-2 focus:ring-primary"
