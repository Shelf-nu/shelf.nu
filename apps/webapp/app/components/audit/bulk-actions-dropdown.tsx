...
import BulkRemoveAssetsFromAuditDialog from "./bulk-remove-assets-from-audit-dialog";
...
function ConditionalDropdown() {
  ...
  return (
    <>
      ...
      <BulkRemoveAssetsFromAuditDialog />
      ...
      >
        ...
        <DropdownMenuContent
          ...
          ref={dropdownRef}
        >
          <div className="order fixed bottom-0 left-0 w-screen rounded-b-none rounded-t-[4px] bg-surface p-0 text-right md:w-[180px] md:rounded-t-[4px]">
            <DropdownMenuItem
