...
export function BookingAssetsSidebar({
  booking,
  trigger,
  dispositionedByAsset: dispositionedByAssetProp,
  dispositionBreakdownByAsset: dispositionBreakdownByAssetProp,
  checkedOutByAsset: checkedOutByAssetProp,
  availableUnitsByAsset,
   ...
   * inline `booking.bookingAssets` wins below and the maps come from
   * props, exactly as before this component went dual-mode.
   */
  ...
  const dispositionedByAsset =
    dispositionedByAssetProp ?? fetchedData?.dispositionedByAsset;
  const dispositionBreakdownByAsset =
    dispositionBreakdownByAssetProp ?? fetchedData?.dispositionBreakdownByAsset;
  const checkedOutByAsset =
    checkedOutByAssetProp ?? fetchedData?.checkedOutByAsset;
  /**
