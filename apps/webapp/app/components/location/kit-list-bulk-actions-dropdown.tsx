...
import BulkRemoveKitsFromLocationDialog from "./bulk-remove-kits-from-location-dialog";
...
export default function KitListBulkActionsDropdown() {
...
function ConditionalDropdown() {
  ...
  return (
    <>
      ...
      <BulkRemoveKitsFromLocationDialog />
