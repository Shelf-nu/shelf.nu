...
// (package.json "main") from apps/mobile/ — not the monorepo root.
config.projectRoot = projectRoot;

// 1. Watch all files in the monorepo
config.watchFolders = [monorepoRoot];

// 2. Prevent Metro from resolving packages outside the mobile app's own
...
// 3. Explicit resolution order: mobile's node_modules first, then monorepo root
